...
insert into public.course_categories (name, slug, description, sort_order, is_active) values
  ...
  ('Trabajos en altura', 'trabajos-en-altura', 'Formación preventiva y pr�?ctica para trabajos con riesgo de caída.', 20, true),
...
with catalog(primary_category, title, slug, modality, image_url, featured) as (
  values
    ...
    ('trabajos-en-altura', 'Curso de trabajos en altura para poda de �?rboles', 'curso-de-trabajos-en-altura-para-poda-de-arboles', 'presential', 'https://images.unsplash.com/photo-1504917595217-d4dc5ebe6122?auto=format&fit=crop&w=1000&q=82', false),
    ...
    ('trekform-online', 'Curso de Microsoft Excel b�?sico', 'curso-de-microsoft-excel-basico', 'online', 'https://images.unsplash.com/photo-1516321318423-f06f85e504b3?auto=format&fit=crop&w=1000&q=82', false),
    ...
    ('prevencion', 'Curso b�?sico de primeros auxilios', 'curso-basico-primeros-auxilios', 'presential', 'https://images.unsplash.com/photo-1504307651254-35680f356dfd?auto=format&fit=crop&w=1000&q=82', true),
    ...
    ('prevencion', 'Curso de prevención b�?sico', 'curso-de-prevencion-basico', 'online', 'https://images.unsplash.com/photo-1504307651254-35680f356dfd?auto=format&fit=crop&w=1000&q=82', false),
    ...
    ('prevencion', 'Curso de riesgo eléctrico b�?sico', 'curso-de-riesgo-electrico-basico', 'presential', 'https://images.unsplash.com/photo-1504307651254-35680f356dfd?auto=format&fit=crop&w=1000&q=82', false),
...
select
  ...
  'Curso orientado a adquirir conocimientos pr�?cticos y trabajar con seguridad.',
  c.modality,
  c.image_url,
  c.featured,
  'published',
