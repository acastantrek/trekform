...
with seed_courses(category_slug, title, slug, excerpt, description, duration_hours, featured) as (
  values
    ('maquinaria-industrial', 'Curso de Carretillas Elevadoras', 'curso-de-carretillas-elevadoras', 'Obtén formación teórica y pr�?ctica para manejar carretillas con seguridad.', 'Curso presencial para particulares y empresas con pr�?cticas reales de conducción y seguridad.', 8.00, true),
    ('maquinaria-industrial', 'Curso de Plataformas Elevadoras (PEMP)', 'curso-de-plataformas-elevadoras-pemp', 'Aprende a operar plataformas elevadoras de forma segura.', 'Formación teórico-pr�?ctica sobre inspección, manejo y prevención de riesgos con PEMP.', 6.00, true),
    ('trabajos-en-altura', 'Curso de Trabajos en Altura', 'curso-de-trabajos-en-altura', 'Formación pr�?ctica para trabajar con seguridad en altura.', 'Uso de EPIs, sistemas anticaídas, anclajes y procedimientos de trabajo seguro.', 8.00, true),
    ...
    ('prevencion', 'Curso B�?sico de Primeros Auxilios', 'curso-basico-primeros-auxilios', 'Protocolos b�?sicos de actuación ante emergencias.', 'Evaluación inicial, soporte vital b�?sico y actuación ante accidentes frecuentes.', 8.00, false),
...
cross join lateral (
  values
    ...
    ('Pr�?cticas y evaluación', 'Aplicación pr�?ctica de los conocimientos y evaluación final.', 240, 3)
...
insert into public.faqs (question, answer, sort_order, is_published) values
  ...
  ('�?Los cursos incluyen pr�?cticas?', 'Los cursos presenciales principales combinan formación teórica con ejercicios pr�?cticos.', 20, true),
...
insert into public.testimonials (author_name, author_role, content, rating, sort_order, is_published) values
  ('Angela D.', 'Alumna', 'El curso fue claro, pr�?ctico y el profesorado tuvo mucha paciencia.', 5, 10, true),
  ('Juan Carlos C.', 'Alumno', 'La teoría y las pr�?cticas estuvieron bien organizadas y fueron muy útiles.', 5, 20, true),
